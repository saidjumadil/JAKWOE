        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                        <h2 class="indent-left margin-bot"><a class="grid1-desc">Register ke Jakwoe.com</a></h2>		
                        </div>
                        <div class="col-md-12">
...
<div class="form-group">
   <label class="sr-only" for="exampleInputAlamat3">Alamat</label>
    ...
    <input type="text" name="alamat" id="exampleInputAlamat3" class="form-control" placeholder="Masukkan Alamat Lengkap anda">
  ...
  <label class="sr-only" for="exampleInputREpassword3">Isikan captcha</label>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="copyright text-muted small">Copyright &copy; Jakwoe Management 2018. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
