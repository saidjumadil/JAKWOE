    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="index.php"><img src="logo/1.png" width="100"></a>
            </div>
...
-->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                        <h2 class="indent-left margin-bot"><a href="index.php" class="grid1-desc">Anda Senang, Kami B Aja</a></h2>		
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="copyright text-muted small">Copyright &copy; <a href="author/">Jakwoe  Management 2018</a>. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
